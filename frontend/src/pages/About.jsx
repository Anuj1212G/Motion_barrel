...
<section className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-800 overflow-hidden">
  <div className="max-w-7xl mx-auto">
    ...
    {/* Container fixed to 3 cards */}
    <div className="relative w-[calc(3*20rem+2*2.5rem)] mx-auto overflow-hidden"> 
      {/* 3 cards width + 2 gaps of 10 (2.5rem) */}
      <motion.div
      ...
      >
        {[
          ...
          <div
            key={index}
            className="bg-slate-700 p-8 rounded-2xl shadow-xl text-center flex-shrink-0 flex flex-col w-80"
          >
            <img
              src={advisor.image}
              alt={advisor.name}
